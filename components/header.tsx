        ...
        >
          ...
          <div className="flex items-center gap-3 md:gap-4">
            <motion.button
              ...
              className="h-[44px] bg-transparent border-l-2 border-r-2 border-white rounded-full flex items-center justify-center px-2 py-2 gap-2 overflow-hidden hover:bg-[#ff3a09]/50 cursor-pointer focus:outline-none relative"
            >
              <motion.span
                initial={{ opacity: 0 }}
